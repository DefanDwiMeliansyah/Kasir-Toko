                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_diskon" id="kode_diskon" 
                                    ...
                                    value="{{ old('kode_diskon', $diskon->kode_diskon) }}" placeholder="Contoh: DISKON10">
                                @error('kode_diskon')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_diskon" id="nama_diskon" 
                                    ...
                                    value="{{ old('nama_diskon', $diskon->nama_diskon) }}" placeholder="Contoh: Diskon Hari Raya">
                                @error('nama_diskon')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="3" 
                            ...
                            placeholder="Deskripsi diskon (opsional)">{{ old('deskripsi', $diskon->deskripsi) }}</textarea>
                        @error('deskripsi')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="nilai_diskon" id="nilai_diskon" step="0.01" min="0"
                                    ...
                                    value="{{ old('nilai_diskon', $diskon->nilai_diskon) }}" placeholder="0">
                                @error('nilai_diskon')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="maksimal_diskon" id="maksimal_diskon" step="0.01" min="0"
                                    ...
                                    value="{{ old('maksimal_diskon', $diskon->maksimal_diskon) }}" placeholder="0">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="minimal_belanja" id="minimal_belanja" step="0.01" min="0"
                                    ...
                                    value="{{ old('minimal_belanja', $diskon->minimal_belanja) }}" placeholder="0">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="maksimal_jumlah_produk" id="maksimal_jumlah_produk" min="1"
                                    ...
                                    value="{{ old('maksimal_jumlah_produk', $diskon->maksimal_jumlah_produk) }}" placeholder="Kosongkan jika tidak ada batas">
                                <small class="text-muted">Kosongkan jika tidak ada batas maksimal</small>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="kuota" id="kuota" min="1"
                                    ...
                                    value="{{ old('kuota', $diskon->kuota) }}" placeholder="Kosongkan jika unlimited">
                                @error('kuota')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_kondisi" id="jenis_kondisi" 
                            ...
                            <option value="semua" {{ old('jenis_kondisi', $diskon->jenis_kondisi) == 'semua' ? 'selected' : '' }}>Semua Produk</option>
                            <option value="kategori" {{ old('jenis_kondisi', $diskon->jenis_kondisi) == 'kategori' ? 'selected' : '' }}>Kategori Tertentu</option>
                            <option value="produk" {{ old('jenis_kondisi', $diskon->jenis_kondisi) == 'produk' ? 'selected' : '' }}>Produk Tertentu</option>
                        </select>
                        @error('jenis_kondisi')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" name="kondisi_ids[]" value="{{ $kategori->id }}" 
                                        ...
                                        {{ in_array($kategori->id, old('kondisi_ids', $diskon->kondisi_ids ?? [])) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" name="kondisi_ids[]" value="{{ $produk->id }}" 
                                        ...
                                        {{ in_array($produk->id, old('kondisi_ids', $diskon->kondisi_ids ?? [])) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="tanggal_berakhir" id="tanggal_berakhir" 
                                    ...
                                    value="{{ old('tanggal_berakhir', $diskon->tanggal_berakhir->format('Y-m-d\TH:i')) }}">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input type="checkbox" name="aktif" value="1" class="form-check-input" id="aktif"
                                {{ old('aktif', $diskon->aktif) ? 'checked' : '' }}>
