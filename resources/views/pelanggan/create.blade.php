        ...
        <form method="POST" action="{{ route('pelanggan.store') }}" class="card card-orange card-outline">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <x-input name="nama" type="text" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')" />
                    <small class="text-muted">Hanya huruf dan spasi yang diperbolehkan</small>
                </div>
                <div class="form-group">
                    <label>Alamat</label>
                    <x-textarea name="alamat" oninput="this.value = this.value.replace(/[^a-zA-Z\s.,]/g, '')" />
                    <small class="text-muted">Hanya huruf, spasi, koma, dan titik yang diperbolehkan</small>
                </div>
                <div class="form-group">
                    <label>Nomor Telepon/HP</label>
                    <x-input name="nomor_tlp" type="text" oninput="this.value = this.value.replace(/[^0-9+\-\s()]/g, '')" />
