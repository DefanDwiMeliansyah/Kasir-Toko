...
<x-alert type="success"><strong>Berhasil dibuat!</strong> Kategori berhasil dibuat.</x-alert>
@endif
@if (session('update') == 'success')
<x-alert type="success"><strong>Berhasil diupdate!</strong> Kategori berhasil diupdate.</x-alert>
@endif
@if (session('destroy') == 'success')
<x-alert type="success"><strong>Berhasil dihapus!</strong> Kategori berhasil dihapus.</x-alert>
@endif
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <a href="{{ route('kategori.edit', ['kategori' => $kategori->id]) }}" class="btn btn-xs text-success p-0 mr-1">
